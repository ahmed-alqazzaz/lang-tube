...
// FORK OF FLUTTER BOTTOM SHEET, BUT ALIGNED TO THE LEFT
...
///
/// Used by [AlignedBottomSheet.onDragStart].
...
///
/// Used by [AlignedBottomSheet.onDragEnd].
...
///    sheets can be created and displayed with the [showAlignedModalBottomSheet]
///    function.
///
/// The [AlignedBottomSheet] widget itself is rarely used directly. Instead, prefer to
/// create a persistent bottom sheet with [ScaffoldState.showBottomSheet] or
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showAlignedModalBottomSheet].
///
/// See also:
///
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showAlignedModalBottomSheet], which can be used to display a modal bottom
///    sheet.
...
class AlignedBottomSheet extends StatefulWidget {
  /// Creates a bottom sheet.
  ///
  /// Typically, bottom sheets are created implicitly by
  /// [ScaffoldState.showBottomSheet], for persistent bottom sheets, or by
  /// [showAlignedModalBottomSheet], for modal bottom sheets.
  const AlignedBottomSheet({
    super.key,
  ...
  /// Use [AlignedBottomSheet.createAnimationController] to create one, or provide
  ...
  /// Defines minimum and maximum sizes for a [AlignedBottomSheet].
  ///
  ...
  @override
  State<AlignedBottomSheet> createState() => _AlignedBottomSheetState();

  /// Creates an [AnimationController] suitable for a
  /// [AlignedBottomSheet.animationController].
  ///
...
class _AlignedBottomSheetState extends State<AlignedBottomSheet> {
...
class _AlignedModalBottomSheet<T> extends StatefulWidget {
  const _AlignedModalBottomSheet({
    super.key,
    required this.route,
    this.backgroundColor,
    this.elevation,
  ...
  final AlignedModalBottomSheetRoute<T> route;
  final bool isScrollControlled;
  final double scrollControlDisabledMaxHeightRatio;
  final Color? backgroundColor;
  final double? elevation;
  ...
  @override
  _AlignedModalBottomSheetState<T> createState() =>
      _AlignedModalBottomSheetState<T>();
}

class _AlignedModalBottomSheetState<T>
    extends State<_AlignedModalBottomSheet<T>> {
...
/// modal bottom sheets (see the documentation for these on [AlignedBottomSheet]
/// for more details).
///
...
/// See also:
///
///  * [showAlignedModalBottomSheet], which is a way to display a ModalBottomSheetRoute.
///  * [AlignedBottomSheet], which becomes the parent of the widget returned by the
///    function passed as the `builder` argument to [showAlignedModalBottomSheet].
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
...
///  * The Material 2 spec at <https://m2.material.io/components/sheets-bottom>.
///  * The Material 3 spec at <https://m3.material.io/components/bottom-sheets/overview>.
class AlignedModalBottomSheetRoute<T> extends PopupRoute<T> {
  /// A modal bottom sheet route.
  AlignedModalBottomSheetRoute({
    required this.builder,
    this.capturedThemes,
    this.barrierLabel,
  ...
  /// bottom sheet.
  ///
  /// Consider setting this attribute when the [AlignedModalBottomSheetRoute]
  ...
  /// the barrier for this [AlignedModalBottomSheetRoute] should be clipped.
  ///
  ...
  AnimationController createAnimationController() {
    ...
    if (transitionAnimationController != null) {
      ...
      _animationController =
          AlignedBottomSheet.createAnimationController(navigator!);
    }
      ...
      child: Builder(
        builder: (BuildContext context) {
          ...
          final BottomSheetThemeData defaults = Theme.of(context).useMaterial3
              ? _BottomSheetDefaultsM3(context)
              : const BottomSheetThemeData();
          return _AlignedModalBottomSheet<T>(
            route: this,
...
/// display the [AlignedBottomSheet] when set to `true`. This is useful in the case
/// that a modal [AlignedBottomSheet] needs to be displayed above all other content
...
///
/// {@tool dartpad}
/// This example demonstrates how to use [showAlignedModalBottomSheet] to display a
...
///
/// {@tool dartpad}
/// This sample shows the creation of [showAlignedModalBottomSheet], as described in:
...
///  * The Material 2 spec at <https://m2.material.io/components/sheets-bottom>.
///  * The Material 3 spec at <https://m3.material.io/components/bottom-sheets/overview>.
Future<T?> showAlignedModalBottomSheet<T>({
  ...
  return navigator.push(AlignedModalBottomSheetRoute<T>(
    builder: builder,
    capturedThemes:
...
/// [constraints] and [transitionAnimationController]
/// parameters can be passed in to customize the appearance and behavior of
/// persistent bottom sheets (see the documentation for these on [AlignedBottomSheet]
/// for more details).
///
/// The [enableDrag] parameter specifies whether the bottom sheet can be
/// dragged up and down and dismissed by swiping downwards.
...
/// [showAlignedModalBottomSheet] function.
///
