...
impl ReadabilityScore {
    pub fn to_map(&self) -> HashMap<String, f64> {
        ...
        map.insert("flesch_kincaid_grade".to_string(), self.flesch_kincaid_grade);
        map.insert("automated_readability_index".to_string(), self.automated_readability_index);
...
impl ReadabilityScore {
    pub fn new(text: &str) -> Self {
        let raw_metrics = TextMetrics::new(text);
