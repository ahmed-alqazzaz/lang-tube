...
abstract class Readability {
  Future<String> calculateTextComplexity(
      {required String text,
      required String language,
      String? cacheDir,
      dynamic hint});

  FlutterRustBridgeTaskConstMeta get kCalculateTextComplexityConstMeta;
...
class ReadabilityImpl implements Readability {
  ...
  Future<String> calculateTextComplexity(
    ...
    var arg1 = _platform.api2wire_String(language);
    var arg2 = _platform.api2wire_opt_String(cacheDir);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_calculate_text_complexity(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_String,
      parseErrorData: _wire2api_String,
      constMeta: kCalculateTextComplexityConstMeta,
      argValues: [text, language, cacheDir],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kCalculateTextComplexityConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "calculate_text_complexity",
        argNames: ["text", "language", "cacheDir"],
      );
...
class ReadabilityWire implements FlutterRustBridgeWireBase {
  ...
  void wire_calculate_text_complexity(
    int port_,
    ffi.Pointer<wire_uint_8_list> text,
    ffi.Pointer<wire_uint_8_list> language,
    ffi.Pointer<wire_uint_8_list> cache_dir,
  ) {
    return _wire_calculate_text_complexity(
      port_,
      text,
      language,
      cache_dir,
  ...
  late final _wire_calculate_text_complexityPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Int64,
                  ...
                  ffi.Pointer<wire_uint_8_list>,
                  ffi.Pointer<wire_uint_8_list>)>>(
      'wire_calculate_text_complexity');
  late final _wire_calculate_text_complexity =
      _wire_calculate_text_complexityPtr.asFunction<
