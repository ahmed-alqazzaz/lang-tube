...
class SourceCaptions {
  ...
  @override
  String toString({bool includeUrl = false}) =>
      'SourceSubtitles(${includeUrl ? 'uri: ${uri.toString()},' : ''} videoId: $videoId, isAutoGenerated: $isAutoGenerated language: ${language?.name})';
