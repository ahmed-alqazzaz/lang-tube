...
abstract class SubtitlesParser {
  Future<List<ParsedSubtitle>> parseSubtitles(
      {required String rawSubtitles, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kParseSubtitlesConstMeta;
}
...
class SubtitlesParserImpl implements SubtitlesParser {
  ...
  Future<List<ParsedSubtitle>> parseSubtitles(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_parse_subtitles(port_, arg0),
      parseSuccessData: _wire2api_list_parsed_subtitle,
      parseErrorData: null,
      constMeta: kParseSubtitlesConstMeta,
...
// Section: wire2api
  ...
  ParsedSubtitle _wire2api_parsed_subtitle(dynamic raw) {
    ...
    return ParsedSubtitle(
      start: _wire2api_rust_duration(arr[0]).toDart(),
      end: _wire2api_rust_duration(arr[1]).toDart(),
...
class SubtitlesParserWire implements FlutterRustBridgeWireBase {
  ...
  void wire_parse_subtitles(
    int port_,
    ffi.Pointer<wire_uint_8_list> raw_subtitles,
  ) {
    return _wire_parse_subtitles(
      port_,
      raw_subtitles,
    );
  }

  late final _wire_parse_subtitlesPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_uint_8_list>)>>('wire_parse_subtitles');
  late final _wire_parse_subtitles = _wire_parse_subtitlesPtr
