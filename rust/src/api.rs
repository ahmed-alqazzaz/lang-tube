...
pub fn calculate_subtitle_complexity(text: String) -> SubtitleComplexity {
...
impl SubtitleComplexity {
    ...
    pub fn compare_to(&self, other: SubtitleComplexity) -> bool{
