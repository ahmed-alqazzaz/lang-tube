...
class _VideoRecommendationsViewState
  ...
  Widget build(BuildContext context) {
    final recommendationsList = ref.watch(recommendationsProvider).valueOrNull;

    log("recommendations ${recommendationsList?.first.videos}");
...
//         subtitlesComplexity: const ReadabilityScore(
//           lixIndex: 1.3821138211382114,
//           rixIndex: 235.0,
//           fleschReadingEase: 61.243414634146376,
...
//           subtitlesComplexity: const ReadabilityScore(
//             lixIndex: 1.2906793048973144,
//             rixIndex: 552.0,
//             fleschReadingEase: 74.977345971564,
//             automatedReadabilityIndex: 950.1839336492892,
//             colemanLiauIndex: 11.803883917086061,
//           ),
...
//         subtitlesComplexity: const ReadabilityScore(
//             lixIndex: 1.3703703703703702,
//             rixIndex: 40.0,
//             fleschReadingEase: 47.5866666666667,
//             automatedReadabilityIndex: 59.78333333333334,
//             colemanLiauIndex: 18.125897435897432),
...
//           thumbnailUrl:
//               'https://i.ytimg.com/vi/G-WO-z-QuWI/hq720.jpg?sqp=-oaymwEcCK4FEIIDSEbyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLDSRkswD9d2A2y1_fvGdmoT6Cr4lw',
//           sourceTab: 'Kurzgesagt – In a Nutshell',
//           badges: ['Kurzgesagt – In a Nutshell', '17M views', '2 years ago'],
//           subtitlesComplexity: ReadabilityScore(
//             lixIndex: 1.3226299694189603,
//             rixIndex: 633.0,
//             fleschReadingEase: 69.7787155963303,
//             automatedReadabilityIndex: 982.4046177370032,
//             colemanLiauIndex: 12.703799456279913,
//           ),
//           syllablesPerMillisecond: 0.005047905247048065,
//           cefr: CEFR.a1,
//         ),
//         RecommendedVideo(
//           duration: "1.12",
...
//           ],
//           subtitlesComplexity: const ReadabilityScore(
//             lixIndex: 1.3679308050565535,
//             rixIndex: 553.0,
//             fleschReadingEase: 51.31101796407188,
//             automatedReadabilityIndex: 755.8731536926148,
//             colemanLiauIndex: 16.40925944079778,
//           ),
...
//           subtitlesComplexity: ReadabilityScore(
//             lixIndex: 1.4223844282238443,
//             rixIndex: 868.0,
//             fleschReadingEase: 48.39401459854017,
//             automatedReadabilityIndex: 1033.4246715328466,
//             colemanLiauIndex: 18.34730092135319,
//           ),
