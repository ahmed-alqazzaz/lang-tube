...
class CustomCurrentPosition extends StatefulWidget {
  /// Overrides the default [YoutubePlayerController].
  final YoutubePlayerController? controller;

  /// Creates [CustomCurrentPosition] widget.
  const CustomCurrentPosition({super.key, this.controller});

  @override
  State<CustomCurrentPosition> createState() => _CustomCurrentPositionState();
}

class _CustomCurrentPositionState extends State<CustomCurrentPosition> {
